...
import com.example.contaService.dto.PixDTO;
import com.example.contaService.dto.PixRequestDTO;
import com.example.contaService.dto.PixResponseDTO;
import com.example.contaService.exception.ContaNaoExistenteException;
import com.example.contaService.exception.PixNegativoException;
import com.example.contaService.exception.SaldoInsuficienteException;
import com.example.contaService.feign.BacenService;
import com.example.contaService.model.Conta;
import com.example.contaService.model.Pix;
import com.example.contaService.repository.ContaRepository;
import com.example.contaService.repository.PixRepository;
...
public class PixService {
    ...
    public PixResponseDTO realizaPix(PixRequestDTO pixRequestDTO) {
        ...
        if (pixRequestDTO.getValor().compareTo(BigDecimal.ZERO) <= 0) {
            throw new PixNegativoException("Nao pode fazer pix negativo");
        }
